...
urlpatterns = [
    ...
    path('travelcourse1/', views.Groad_travelcourse1_List.as_view()),
    path('travelcourse2/', views.Groad_travelcourse2_List.as_view()),
    path('travelcourse3/', views.Groad_travelcourse3_List.as_view()),
    path('travelcourse4/', views.Groad_travelcourse4_List.as_view()),
