...
class Groad_user_List(APIView):
    ...
    def post(self, request):
        ...
        (gu_id, gu_pw, gu_name, gu_gender, gu_birth_date, gu_email, gu_phone_number, gu_point_number,gu_step_number)
            value('{gu_id}','{gu_pw}','{gu_name}','{gu_gender}','{gu_birth_date}','{gu_email}','{gu_phone_number}',0,0)
        """
        try:
            cur = connection.cursor()
            cur.execute(sql)
